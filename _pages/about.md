...
My friends and I designed a [custom x86 implementation](/files/x86_uarch_sp26.pdf) from architectural specification to functional verifiation using only structural gate primatives in three months. Our processor features a 6-stage pipeline with a Banked I-Cache, Next-line Prefetcher, G-Share Branch Predictor, Non-blocking Writeback D-Cache, Non-Stalling Writeback Stage, Double-Clocked Address and Data Bus, and an advanced D-Cache replacement policy. Moreover, we interface I/O devices such as a Keyboard and DMA, and support interrupt and exception handling. This was for our [Microarchitecture](https://users.ece.utexas.edu/~patt/26s.382N/) class with Dr. Yale Patt.
